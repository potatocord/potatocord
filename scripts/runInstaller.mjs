...
const BASE_URL = "https://github.com/potatocord/Installer/releases/latest/download/";
const INSTALLER_PATH_DARWIN = "PotatocordInstaller.app/Contents/MacOS/PotatocordInstaller";
...
function getFilename() {
    switch (process.platform) {
        case "win32":
            return "PotatocordInstallerCli.exe";
        case "darwin":
            return "PotatocordInstaller.MacOS.zip";
        case "linux":
            return "PotatocordInstallerCli-linux";
        default:
...
async function ensureBinary() {
    ...
    const outputFile = process.platform === "darwin"
        ? join(FILE_DIR, "PotatocordInstaller")
        : downloadName;
    ...
    const res = await fetch(BASE_URL + filename, {
        headers: {
            "User-Agent": "Potatocord (https://github.com/potatocord/potatocord)",
            "If-None-Match": etag
        }
    });
    ...
    if (process.platform === "darwin") {
        ...
        logAndRun(`sudo spctl --add '${outputFile}' --label "Potatocord Installer"`);
